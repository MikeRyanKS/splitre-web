...
related: ["real-estate-brokerage-accounting-basics", "eliminate-commission-spreadsheets"]
---
...
Do this before the first payment, not at year end. QBO's 1099 report only captures payments made through properly configured vendor records. Payments entered elsewhere don't flow into the report automatically, and manually reconstructing them is exactly as unpleasant as it sounds. For the underlying 1099 rules, including the LLC/S-corp distinction, see [Real Estate Brokerage Accounting: What Every Broker Needs to Know](/blog/real-estate-brokerage-accounting-basics#1099-preparation).
...
The cleaner approach is to calculate commissions in a dedicated tool and [export the accounting data rather than entering everything by hand](/docs/sharing-and-exporting-deals).

SplitRE generates a QuickBooks-ready CSV export for every batch of deals, formatted with closing dates, property addresses, agents, GCI amounts, agent net payouts, broker net revenue, and memo lines that map directly to QBO invoices and bills. You hand the file to your bookkeeper, they import it into QBO, and the manual re-keying step is gone entirely, with no more [maintaining a parallel spreadsheet](/blog/eliminate-commission-spreadsheets) just to get numbers into your books.
...
SplitRE calculates every deal and hands you a QuickBooks-ready export with one click. See [Pricing](/pricing) or [try the calculator](/real-estate-commission-split-calculator) on a real deal first.
