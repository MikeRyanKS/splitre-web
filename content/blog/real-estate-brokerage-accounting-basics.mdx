...
related: ["quickbooks-online-real-estate-brokerage", "how-to-calculate-real-estate-agent-commission"]
---
...
## Start with GCI, your real top line
...
When an agent closes a deal and earns their commission, you pay them their portion. That payment is an expense, specifically Agent Commission Expense. This is the largest variable cost most brokerages carry, and it should be tracked clearly and consistently. For how that portion is actually calculated, including splits, tiers, and caps, see [How to Calculate Real Estate Agent Commission](/blog/how-to-calculate-real-estate-agent-commission).

If you're in QuickBooks or a similar accounting tool, agents should be set up as vendors, and every payment should flow through their vendor record. This is what enables 1099 generation at year end. If payments go through miscellaneous accounts or are netted against income instead of recorded as expenses, the year-end 1099 process becomes a manual reconstruction project that no bookkeeper enjoys. For the QuickBooks Online-specific setup steps, see [QuickBooks Online for Real Estate Brokerages: A Practical Setup Guide](/blog/quickbooks-online-real-estate-brokerage).
...
Brokerages typically handle E&O one of two ways. Some pay an annual premium out of operating expenses and absorb the cost at the brokerage level. Others charge agents a per-deal E&O fee (usually $100 to $300) that comes off the agent's portion of each commission, which offsets the brokerage's premium cost.
...
SplitRE calculates GCI, splits, and deductions correctly on every deal and exports a QuickBooks-ready CSV your bookkeeper can use as-is. See [Pricing](/pricing) or [try the calculator](/real-estate-commission-split-calculator) free.
