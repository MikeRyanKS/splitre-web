...
When an agent closes a deal and earns their commission, you pay them their portion. That payment is an expense, specifically Agent Commission Expense. This is the largest variable cost most brokerages carry, and it should be tracked clearly and consistently. For how that portion is actually calculated — splits, tiers, caps — see [How to Calculate Real Estate Agent Commission](/blog/how-to-calculate-real-estate-agent-commission).
