...
3. **Agent deductions** — things that come out of the agent's share specifically: E&O insurance, transaction fees, desk fees, training/mentor fees, or custom deductions. What's left is the **agent's net payout**.
