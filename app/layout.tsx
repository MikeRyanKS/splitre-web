...
export const metadata: Metadata = {
  ...
  description:
    "SplitRE automates real estate commission calculations, agent cap tracking, and bookkeeper-ready CSV exports for independent brokerages. Replace spreadsheets and pay agents correctly, every time. Plans from $29/mo (annual).",
