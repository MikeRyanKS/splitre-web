...
Keplify LLC ("we," "us," or "our") operates SplitRE at splitre.app and app.splitre.app (collectively, the "Service"). This Privacy Policy describes what information we collect, how we use it, who we share it with, how long we keep it, and the rights you have over it. It applies to visitors of our marketing website and to registered subscribers of the SplitRE application.
...
By using the Service you agree to the practices described in this Policy, which is incorporated into our [Terms of Service](/terms) by reference. If you do not agree, do not use the Service.
...
Our servers automatically record IP address, browser type and version, operating system, referring URL, pages viewed, timestamps, and error events, to maintain uptime, diagnose bugs, and understand aggregate feature usage. Log data is retained for up to 90 days.
...
If you email us, we retain the content of that correspondence to resolve your issue and improve the Service.
...
**We do not use your data to train AI or machine-learning models. We do not sell, rent, or share your personal information or brokerage data with third parties for their own marketing purposes. We do not engage in automated decision-making that produces a legal or similarly significant effect on you or your agents.**

---

## 3. Third-Party Subprocessors

We use a limited number of subprocessors to operate the Service, each bound by a data protection agreement and permitted to use your data only to perform the service it provides us.
...
- Row-level security policies logically isolate your brokerage data from every other customer's;
- Production access is limited to authorized personnel using multi-factor authentication;
...
Our website and application may link to third-party sites (QuickBooks Online, the Stripe billing portal, external documentation). We are not responsible for the privacy practices of those sites and encourage you to review their policies before sharing personal information with them.
...
**How to submit a request:** email legal@splitre.app with the subject line "California Privacy Rights Request," including your name, the account email (if applicable), and a description of the right you want to exercise. We will verify your identity and respond within 45 calendar days, extendable by another 45 days with written notice to you. You may designate an authorized agent to submit a request on your behalf with written authorization and identity verification.
...
The Service is a business tool intended for adults (18 or older). We do not knowingly collect personal data from children under 13. If you believe a child under 13 has provided us personal data, contact legal@splitre.app and we will promptly delete it.

---

## 12. Changes to This Policy

We may update this Privacy Policy. When we make a material change, we update the effective date above and notify active subscribers by email at least 14 days before the change takes effect. Continued use of the Service after the effective date of a revised Policy means you accept the update.
